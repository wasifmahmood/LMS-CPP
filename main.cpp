...
int main()
{
    ...
    // Create books
    Book harryPotter("Harry Potter and the Sorcerer's Stone", "978", "Fantasy");
    Book LifeShafak("The Lord of the Rings", "979", "Romantic");
    Book Thinkpad("The Hobbit", "07122", "Computer");
